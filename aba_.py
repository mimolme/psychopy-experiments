...
# guide lines
ax.plot([upper_line_left, upper_line_right], [y_B, y_B], color='black', lw=1.0)
ax.plot([lower_line_left, lower_line_right], [y_A, y_A], color='black', lw=1.0)
...
for i, (x1, x2) in enumerate(pairs):
    ...
    ax.plot([x1, x1], [left_tick_bottom, tick_top], color='black', lw=1.0)
    ax.plot([x2, x2], [right_tick_bottom, tick_top], color='black', lw=1.0)
